...
import Eligibility from "./pages/Programme/components/gcip-lot-stages/eligibility";
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        <Route path="Profile" element={<Eligibility />} />
      </Route>
      <Route
        path="Programme"
        element={
        ...
        {/* <Route path="Programme/:appId/continue" element={<Eligibility />} /> */}
