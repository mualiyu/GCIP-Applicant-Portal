  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const response = await fetch(
        "https://api.gcip.rea.gov.ng/api/applicant/register",
        {
          method: "POST",
          body: formData,
        }
        ...
        <div className="col-10 flex flex-center shadow_light auth_register mt-xl light bubble3">
          ...
          <div className="col-7 pl-xl pr-xl bubble2">
            <div className="form-container">
              ...
              <div className="form__group__register field col-5">
                <input
                  type="input"
                  className="form__field"
                  placeholder="ABC Company"
              ...
              <div className="flex">
                  ...
                  onChange={formik.handleChange} required />
                            ...
                            <div className="form__group__register field col-12 ml-sm">
                                <input type="text" className="form__field" placeholder="" value={formik.values.person_incharge} name="person_incharge"
                  onChange={formik.handleChange} required />
                        ...
                        <div className="flex">
                            <div className="form__group__register field col-12 mr-sm">
                                <input type="number" className="form__field" placeholder="" value={formik.values.phone}
                  name="phone"
                  onChange={formik.handleChange} required />
                  ...
                  onChange={formik.handleChange} required />
                        ...
                        <div className="form__group__register field col-12">
                <input
                  type="input"
                  className="form__field"
              ...
              <div className="mt-xl">
              <p className="center m-md">Already have an account? <span onClick={() => navigate("login")} className="bold">Login
                            </span></p>
