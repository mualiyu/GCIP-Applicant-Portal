...
<section className="wrapper bubble">
        ...
        <div className="col-10 flex flex-center shadow_light auth_register mt-xl light bubble3">
          <div className="col-5 login-banner"></div>
          <div className="col-8 pl-xl pr-xl bubble2">
            <div className="form-container">
              ...
              <div className="flex">
                            <div className="form__group field col-9 mr-sm">
                <input
                  type="input"
              ...
              <div className="form__group field col-3">
                <input
                  type="input"
                  className="form__field"
                  placeholder="ABC Company"
