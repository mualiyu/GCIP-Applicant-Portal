...
function Login() {
  ...
  const [openAdvisableModal, setOpenAdvisableModal] = useState(false);
...
<p>Pilot Minigrids in Rural Communities </p>
        ...
        <div className="auth_inner_container">
          ...
          <img src="main_logo.jpeg" alt="logo" style={{position: 'relative', left: '100%'}} />
          <img src="AMP-logo-yellow.png" alt="logo" style={{position: 'absolute', left: '20%', top: '10%'}} />
          </div>
      ...
      >
          ...
          >
            ...
            <div className="">
             ...
             For better experience, it is advisable you use the Google Chrome or Mozilla Firefox browser.
             </p>
            </div>
