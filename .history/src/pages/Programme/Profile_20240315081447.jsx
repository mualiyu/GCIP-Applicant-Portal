      ...
      <div class="row">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p>Looks like you are not verified yet. Verify yourself to use the full
                                                potential of Lithium Stocks</p>
                                        </div>
                                    </div>
                                    <ul>
                                        <li><a href="#"><span class="verified"><i class="fi fi-bs-check"></i></span>Verify
                                                account</a></li>
                                        <li><a href="#"><span class="not-verified"><i class="fi fi-rs-shield-check"></i></span>Upload KYC
                                                Documents</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xxl-4 col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Refer your friends and earn 12% of <br> their trading fees.</p>
