      ...
      <div className="program_header_head">
        <div className="program_main_label">
          ...
          <p>Application Status: &nbsp;
            ...
            {current?.status == null ? 'Draft Application' :  current?.status == 1 ? 'Application Submitted' : current?.status == 2 ? 'Queried' : current?.status == 3 ? 'Successful' : current?.status == 5 ? 'Under Review' : 'Unsuccessful'}
            </span></p>
        </div>
