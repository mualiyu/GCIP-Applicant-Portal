...
function Documents({ saveData, nextRun }) {
  ...
  const allDocs = [
    ...
    {
      name: "Attach the last 3 years’ audited account (2020, 2021, 2022) and statement of account for the immediate past six (6) months (January – June 2023).",
  ...
  return (
    <div>
      ...
      >
        ...
        <span>RELEVANT DOCUMENTS UPLOAD  <a href="https://grants.amp.gefundp.rea.gov.ng/how-to-reduce-pdf.html"  target="_blank">(See Guide)</a>  -</span>
        <span
          onClick={() => {
            setModalOpen2(true);
          }}
      ...
      >
        ...
        >
          ...
          <Select
            outlined
            disabled={notUploadedeSelect.length == 0}
            value={selectedName}
            style={{
              maxWidth: "92%",
            }}
          ...
          <Input
            ...
            onChange={(e) => {
              ...
              const fileSizeLimits = 2 * 1024 * 1024; // 4 MB
              setDont(true);
              const file = e.target.files[0];
              const allowedExtensions = ['pdf', 'jpeg', 'jpg'];
              const fileExtension = file.name.split('.').pop().toLowerCase();

              if(file[0].size <= fileSizeLimits) {
