  ...
  return (
    <div className="finance_container">
      ...
      >
        ...
        >
          <Header text="ADD FINANCING INFORMATION" />
          <>
          ...
          <div className="">
            ...
            <Input
              ...
              outlined
              style={{ width: "50%" }}
              label="Aggregate Amount of financing (Naira - in case of fereign currencies, convert with CBN official rate to naira at the time of financial close)"
            />
            <Input
            ...
            <Input
              ...
              type="file"
              // outlined
              label="Evidence of supporting document (Letter of intent, loan agreement e.t.c)"
              name="financial_dept_info.borrower.address"
            />
            {formik2.values.financial_dept_info.evidence_of_support && (
