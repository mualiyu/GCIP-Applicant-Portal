...
export default function Reference({ moveToTab, saveData, nextMove }) {
  ...
  return (
    <div className="ref-container" style={{ marginTop: "75px" }}>
      ...
      <Warning msg="Verifiable evidence of company’s experience in the past 7 years relevant to building, operating, and maintaining renewable mini grids, ownership of or partnership with agricultural facilities and productive use ventures in the selected Lot’s, and acquisition of co-funding (grants, third party equity or debt) for rural electrification projects" />
          ...
          <>
            ...
            <div className="sub_input">
              ...
              <Input
                ...
                // outlined
                type="file"
                label="Evidence of equity or debt required for the project"
              />
            </div>
