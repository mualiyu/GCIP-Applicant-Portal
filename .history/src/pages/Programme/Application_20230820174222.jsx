      ...
      <div className="program_header_head">
        <div className="program_main_label">
          ...
          <p>Application Status: &nbsp;
            <span style={{fontWeight: 900, color: current?.status == null ? 'yellow' :  current?.status == 1 ? 'blue' : current?.status == 2 ? 'green' : current?.status == 3 ? 'lemon' : current?.status == 5 ? 'grey' : 'red'}}>
