...
export default function ReviewAndSubmit() {
  ...
  const checkIfRequirementsUploaded = () => {
    ...
    // console.log(project_requirements, applicant_uploaded_documents);
    const requirementIds = projects.project_requirements?.map((req) => req.id);
    const uploadedRequirementIds = projects.applicant_uploaded_documents?.map(
