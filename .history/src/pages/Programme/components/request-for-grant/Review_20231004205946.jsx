        ...
        <div
          ...
          <div className="">
            <p style={{ lineHeight: "2em", fontSize: 12, paddingTop: 30 }}>
              WE HAVE RECEIVED YOUR PROPOSAL AND WE SHALL EVALUATE DOCUMENTS YOU
              HAVE PROVIDED AS REQUESTED. YOU WILL BE NOTIFIED VIA EMAIL WHEN
              YOUR PROPOSAL HAS BEEN REVIEWED. THANK YOU
            </p>
          </div>
