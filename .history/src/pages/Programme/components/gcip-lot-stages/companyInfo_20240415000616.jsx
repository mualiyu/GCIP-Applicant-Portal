      ...
      <section>
        <section style={{ display: "flex" }}>
          <div
            ...
            <input
              ...
              value={companyInfo.numberOfStaff}
              onChange={(e) => {
        ...
        <div style={{ margin: "15px 0" }}>
          ...
          <Editor
            ...
            value={companyInfo.corporateProfile}
        ...
        <div style={{ margin: "15px 0" }}>
          ...
          <Editor
            apiKey="2bibih7gzun78pn5zdau9mp238v6osoplllh9qw1lgb3rzws"
            value={companyInfo.shortTermObjectives}
        ...
        <div style={{ margin: "15px 0" }}>
          ...
          <Editor
            apiKey="2bibih7gzun78pn5zdau9mp238v6osoplllh9qw1lgb3rzws"
            value={companyInfo.mediumTermObjectives}
        ...
        <div style={{ margin: "15px 0" }}>
          ...
          <Editor
            apiKey="2bibih7gzun78pn5zdau9mp238v6osoplllh9qw1lgb3rzws"
            value={companyInfo.longTermObjectives}
