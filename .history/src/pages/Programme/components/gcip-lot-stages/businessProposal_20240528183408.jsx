...
export default function BusinessProposal() {
  ...
  const [businessProposalData, setBusinessProposalData] = useState([]);
  ...
  useEffect(() => {
    const fetchSubmissionStatus = async () => {
      ...
      if (success) {
        console.log(data);
        setEligibilityData(data.data.application.application_business_proposal);
        setLoading(false);
        if (data?.application?.application_business_proposal != null) {
