...
function EligibilityDocuments({ saveData, nextRun }) {
  ...
  const handleDocumentSelect = (document) => {
    // Remove the selected document from the dropdown list
    const updatedDocuments = documents.filter(doc => doc !== document);
    setDocuments(updatedDocuments);
    
    // Add the selected document to the list of selected documents
              ...
              fetch(
                ...
                .then((data) => {
                  ...
                  if (data.status) {
                    ...
                    setModalOpen2(false);
                    const updatedSelectedDocuments = selectedDocuments.filter(doc => doc !== document);
