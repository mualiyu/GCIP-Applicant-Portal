        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4" style={{ marginLeft: 5 }}>
          <div class="card">
            ...
            <div class="card-body">
              <div class="app-link">
                    <div class="card-header flex-row">
                      <h5> Describe your company’s corporate profile showing your operational and service areas</h5>
                      <a class="" href="#">
                      {submissions?.data.application.application_company_info.profile}
                      </a>
                    </div>
              </div>
            </div>
            <div class="app-link">
                    <div class="card-header flex-row">
                      ...
                      <a class="" href="#">
                      {submissions?.data.application.application_company_info.long_term_objectives}
                      </a>
                    </div>
            </div>
            <div class="app-link">
                    <div class="card-header flex-row">
                      ...
                      <a class="" href="#">
                      {submissions?.data.application.application_company_info.medium_term_objectives}
                      </a>
                    </div>
              </div>
              <div class="app-link">
                    <div class="card-header flex-row">
                      <h5> Short term objectives for current year (include bullet points as applicable)</h5>
                      <a class="" href="#">
                      {submissions?.data.application.application_company_info.short_term_objectives}
                      </a>
                    </div>
              </div>
              <div class="app-link">
                    <div class="card-header flex-row">
                      ...
                      <a class="" href="#">
                      {submissions?.data.application.application_company_info.number_of_staff}
                      </a>
                    </div>
              </div>
              <div class="app-link">
                    <div class="card-header flex-row">
                      <h5> organizational chart providing an overview of personnel/staff involved, in the business in order of hierarchy i.e. CEO, COO, Directors, technical staff etc. Include names, gender, age and pictorial reference.
</h5>
                      <a class="" href="#">
                      {submissions?.data.application.application_company_info.organizational_chart}
                      </a>
                    </div>
              </div>
            </div>
