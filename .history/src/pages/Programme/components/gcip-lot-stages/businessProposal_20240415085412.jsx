...
export default function BusinessProposal() {
  ...
  const formik = useFormik({
    ...
    if(
        initialValues.corporateProfile === "" ||
        initialValues.mediumTermObjectives === "" ||
        initialValues.needForTechnology === "" ||
        initialValues.needForGrant === "" ||
        initialValues.valueAdditions === "" ||
        initialValues.carbonEmissions === "" ||
        initialValues.authority === "" ||
        initialValues.survey === "" ||
        initialValues.surveyUpload === ""
