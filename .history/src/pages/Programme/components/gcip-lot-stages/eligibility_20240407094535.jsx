    ...
    <>
      ...
      <Box
        ...
        <TabPanel className="pd-30 w-100" value={value} index={1}>
          <h2 style={{ marginBottom: 30, fontWeight: 900, color: "blue" }}>
            {" "}
          ...
          <section>
            ...
            <div
              ...
              className="sub-group">
              <div style={{ width: "50%" }}>
                Does your company possess an innovative idea/product which meets
                a critical need for “clean-tech challenges”?
              </div>
