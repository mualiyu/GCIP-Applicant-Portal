...
function EligibilityDocuments({ saveData, nextRun }) {
  ...
  const allDocs = [
    ...
    {
      name: "Sworn Affidavit stating <br/> 1. Company/business is not in receipt of or the subject of any form of insolvency or bankruptcy, proceedings or the subject of any form of winding up petition or proceedings <br/> 2. Company/business does not have any director who has been convicted in any country for any criminal offense relating to fraud or financial impropriety in any country <br/> 3. Disclosing whether or not any GCIP implementing or executing entity member of staff or project steering committee member is a former or present director, shareholder or has any pecuniary interest in the SME <br/> 4. confirming that all information presented in its bid are true and correct in all particulars",
        ...
        <tbody>
          ...
          {Uploaded.length == 0 && (
            <div
              ...
              <span id="empty">No Documents uploaded yet!</span>
            </div>
          )}
        </tbody>
      </table>
