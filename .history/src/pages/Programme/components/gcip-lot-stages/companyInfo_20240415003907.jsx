...
export default function CompanyInfo() {
  ...
  const handleSubmit = async () => {
    ...
    const description_of_products: document.getElementById("productDescription");
    const short_term_objectives: document.getElementById("shortTermObjectives");
    const medium_term_objectives: document.getElementById("mediumTermObjectives");
