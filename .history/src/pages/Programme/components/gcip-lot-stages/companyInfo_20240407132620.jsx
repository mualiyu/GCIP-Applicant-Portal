      ...
      <section>
        ...
        <div className="flex" style={{ margin: "15px 0" }}>
          <div className="form__group__register field col-12 mr-sm">
            ...
            />
            <label className="form__label" style={{ paddingBottom: 20 }}>
              Upload a properly labeled organizational chart providing an
              overview of personnel/staff involved, in the business in order of
              hierarchy i.e. CEO, COO, Directors, technical staff etc. Include
              names, gender, age and pictorial reference.
            </label>
          </div>
        </div>
