              ...
              <div class="welcome-profile">
                ...
                <div class="d-flex align-items-center">
                  <div className="short_name">
                    <span>
                      {data?.user?.user?.name?.split("")[0]}{" "}
                      {data?.user?.user?.name?.split("")[1]}
                    </span>
                  </div>
                  <div class="ms-3">
                    <h4>
                      Welcome,{" "}
                      {data.user.user.inCharge
                        ? data.user.user.inCharge
                        : "N/A"}{" "}
                      !
                    </h4>
                ...
                <ul>
                  <li>
                    <a href="#">
                      <div class="user-info">
                        Company Name :{" "}
                        <span className="inffdgshd">{data.user.user.name}</span>
                      </div>
                    </a>
                  </li>
                  <li>
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4" style={{ marginLeft: 5 }}>
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Eligibiity Documents Uploaded</h4>
            </div>
            <div class="card-body">
              <div class="app-link">
