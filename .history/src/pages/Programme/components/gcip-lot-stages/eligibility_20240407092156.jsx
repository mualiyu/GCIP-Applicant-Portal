  ...
  return (
    <>
      ...
      <Box
        ...
        <TabPanel className="pd-30" value={value} index={0}>
          <div>
            <h2>Selected Lot Title</h2>
        ...
        <TabPanel className="pd-30" value={value} index={1}>
          Item Two
        </TabPanel>
        <TabPanel className="pd-30" value={value} index={2}>
          Item Three
        </TabPanel>
        <TabPanel className="pd-30" value={value} index={3}>
          Item Four
        </TabPanel>
        <TabPanel className="pd-30" value={value} index={4}>
          Item Five
        </TabPanel>
      </Box>
    </>
