            ...
            <div className="direction-ltr">
              <Editor
                ...
                init={{
                  ...
                  content_style:
                    "body { font-family:Helvetica,Arial,sans-serif; font-size:12px; direction: ltr }",
                  setup: (editor) => {
                    editor.on("init", () => {
                      const tinymceEditor = document.getElementById("reason"); // Get the editor element
                      if (tinymceEditor) {
                        tinymceEditor.setAttribute("dir", "ltr"); // Set the dir attribute to "ltr"
                      }
                    });
                  },
                }}
