...
export default function Eligibility() {
  ...
  const [eligibilityData, setEligibilityDate] = useState([]);
  ...
  useEffect(() => {
    const fetchSubmissionStatus = async () => {
      ...
      if (success) {
        console.log(data);
        setEligibilityData(data.application.application_eligibility);
        if (data?.application?.application_eligibility != null) {
