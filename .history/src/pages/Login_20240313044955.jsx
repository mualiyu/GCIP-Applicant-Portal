...
function Login() {
  ...
  return (
    <Fade>
      <section class="wrapper bubble">
        <Loading loading={loading} />
        <Alert text={alertText} />
        <div class="col-9 flex flex-center shadow_light auth mt-xl light bubble3">
          <div class="col-8 login-banner"></div>
          <div class="col-5 pl-xl pr-xl bubble2">
            <div class="form-container">
              <p>* Crypto Product System</p>
              <h2 class="title mt-xl heading">Welcome back </h2>
              <p class="sub_title mb-xl"> You've been missed!</p>
              ...
              <p class="sub-title right uppercase mt-n20">
                {" "}
                <a
                  onClick={() => {
                    navigate("forgot");
                  }}
                  class="forgotten pointer bold">
                  Forgotten?
                </a>
              </p>
              {/* <a href="../Pages/landing.html"> */}
              <button
                class="btn btn-lg btn-accent bold mt-xxl"
              ...
              {/* </form> */}
              <div class="mt-xl">
                <p class="center m-md">Don't have an account yet? </p>
